...
//#include <stdint.h>
//
////Output of the module will vary between Vdd and GND
////The output will not be linear, check the datasheet for the resistor ratios!
//void setOutput(uint8_t code)
//{
//    OPA1CON1bits.GSEL = code;
//}
//
//void main(void) {
//    
//    OPA1CON0 = 0x00;
//    OPA1CON0bits.UG = 1;        //Enable Unity Gain
//    
//    OPA1CON1 = 0x00;
//    OPA1CON1bits.RESON = 1;
//    OPA1CON1bits.NSS = 0b111;   //Set the negative pin to Vss
//    
//    OPA1CON2 = 0x00;            //Keep NCH set to 0b000 for proper operation
//    OPA1CON2bits.PCH = 0b001;   //In+ = Resistor Input
//    
//    OPA1CON3 = 0x00;
//    OPA1CON3bits.FMS = 0b01;    //Select Vdd
//    
//    OPA1HWC =  0x00;            //No hardware overrides
//    
//    OPA1CON0bits.EN = 1;        //Enable the OPA Module
//    
//    uint8_t dacValue = 0;
//    
//    //Generates a sawtooth waveform with the 3-bit DAC
//    while (1)
//    {
//        __delay_us(100);
//        
...
//        setOutput(dacValue);
//        
//        //Increment to the next output level
//        dacValue++;
//        
